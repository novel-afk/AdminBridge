  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        // Make sure this dashboard is only accessible to bank managers
        if (parsedUser.role !== 'BankManager') {
          navigate('/login');
          return;
        }
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg p-6">
            ...
            <div className="bg-yellow-50 p-4 rounded-md mb-6">
              <p className="text-yellow-800">
                <span className="font-medium">Role:</span> Bank Manager
              </p>
              {user && (
                <>
            ...
            <p className="text-gray-600">
              Welcome to your Bank Manager dashboard. From here, you can manage student loans and financial records.
            </p>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium text-gray-900">Student Loans</h3>
                ...
                <div className="bg-gray-50 px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <a href="#" className="font-medium text-yellow-600 hover:text-yellow-500">View loans</a>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div className="bg-gray-50 px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <a href="#" className="font-medium text-yellow-600 hover:text-yellow-500">View reports</a>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    View student payment records and history.
                  </p>
                </div>
                <div className="bg-gray-50 px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <a href="#" className="font-medium text-yellow-600 hover:text-yellow-500">View payments</a>
                  </div>
                </div>
              </div>
            </div>
