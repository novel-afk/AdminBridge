...
// Email recipient from config
const recipientEmail = config.TEST_RECIPIENT || 'damdilip2@gmail.com';
...
console.log(`Using sender: ${config.EMAIL_USER}`);
console.log('\nIMPORTANT: Before this will work, you must update emailConfig.js with your actual Gmail credentials.\n');
